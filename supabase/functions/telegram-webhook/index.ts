...
const translations = {
  ARM: {
    welcome: "Բdelays MedBook! Delays lezu:",
    enterName: "Khndrum enq gravel dzez anun (Anun Azganun):",
    sharePhone: "Khndrum enq khasvatsvel dzez herakhosy:",
    sharePhoneButton: "📱 Khasvatsvel herakhosy",
    chooseService: "Entrequys tsarrayutyuny:",
    otherService: "🔹 Ayl",
    enterCustomReason: "Nkaragrequs dzez aycelutyuny patchar:",
    chooseDate: "Entrequys amsativ:",
    chooseTime: "Entrequys zham:",
    confirmBooking: "Hastatequys granchum?",
    bookingConfirmed: "✅ Dzez granchumy stacvats e! Bjishky piti hastateli ayn.",
    bookingDetails: "📋 Granchumi mankramasnuryunner:",
    service: "Tsarrayutyun",
    dateTime: "Amsativ u zham",
    waitConfirmation: "Spasequm enq bjishki hastatman...",
    appointmentConfirmed: "✅ Dzez granchumy hastatatvats e!\n\n👨‍⚕️ Bjishk: Dr. {doctorName}\n📅 {dateTime}",
    appointmentRejected: "❌ Dzez granchumy merzheche.\n\nPatchar: {reason}",
    noSlots: "Ayl azkani slotner chkan ayt ory. Khndrum enq entrequs urishy.",
    yes: "✅ Hastatiel",
    no: "❌ Chgel",
    back: "◀️ Het",
  },
    ...
    if (update.message) {
      ...
      if (text === '/start' || !session.language) {
        ...
        const keyboard = {
          inline_keyboard: [
            [
              { text: '🇦🇲 Հdelays', callback_data: 'lang_arm' },
